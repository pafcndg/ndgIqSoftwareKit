...
#define MASK_EPILOGUE_CFI (1 << 10)
#define MASK_LL64 (1 << 11)
#define MASK_LONG_CALLS_SET (1 << 12)
#define MASK_MIXED_CODE_SET (1 << 13)
#define MASK_MPY_SET (1 << 14)
#define MASK_MPY16_SET (1 << 15)
#define MASK_MULMAC_32BY16_SET (1 << 16)
#define MASK_MUL64_SET (1 << 17)
#define MASK_NO_BRCC_SET (1 << 18)
#define MASK_NO_COND_EXEC (1 << 19)
#define MASK_DPFP_DISABLE_LRSR (1 << 20)
#define MASK_NO_MILLICODE_THUNK_SET (1 << 21)
#define MASK_NORM_SET (1 << 22)
#define MASK_NO_SDATA_SET (1 << 23)
#define MASK_SIMD_SET (1 << 24)
#define MASK_SPFP_COMPACT_SET (1 << 25)
#define MASK_SPFP_FAST_SET (1 << 26)
#define MASK_SWAP_SET (1 << 27)
#define MASK_VOLATILE_CACHE_SET (1 << 28)
#define MASK_LRA (1 << 29)
...
enum opt_code
{
  ...
  OPT_mepilogue_cfi = 1082,                  /* -mepilogue-cfi */
  OPT_mexpand_adddi = 1083,                  /* -mexpand-adddi */
  OPT_mfpu_ = 1084,                          /* -mfpu= */
  OPT_mindexed_loads = 1085,                 /* -mindexed-loads */
  OPT_mirq_ctrl_saved_ = 1086,               /* -mirq-ctrl-saved= */
  OPT_misize = 1087,                         /* -misize */
  OPT_mlittle_endian = 1088,                 /* -mlittle-endian */
  OPT_mll64 = 1089,                          /* -mll64 */
  OPT_mlock = 1090,                          /* -mlock */
  OPT_mlong_calls = 1091,                    /* -mlong-calls */
  OPT_mlra = 1092,                           /* -mlra */
  OPT_mlra_priority_compact = 1093,          /* -mlra-priority-compact */
  OPT_mlra_priority_noncompact = 1094,       /* -mlra-priority-noncompact */
  OPT_mlra_priority_none = 1095,             /* -mlra-priority-none */
  OPT_mmac_24 = 1096,                        /* -mmac-24 */
  OPT_mmac_d16 = 1097,                       /* -mmac-d16 */
  OPT_mmedium_calls = 1098,                  /* -mmedium-calls */
  OPT_mmixed_code = 1099,                    /* -mmixed-code */
  OPT_mmpy = 1100,                           /* -mmpy */
  OPT_mmpy_option_ = 1101,                   /* -mmpy-option= */
  OPT_mmpy16 = 1102,                         /* -mmpy16 */
  OPT_mmul32x16 = 1103,                      /* -mmul32x16 */
  OPT_mmul64 = 1104,                         /* -mmul64 */
  OPT_mno_brcc = 1105,                       /* -mno-brcc */
  OPT_mno_cond_exec = 1106,                  /* -mno-cond-exec */
  OPT_mno_dpfp_lrsr = 1107,                  /* -mno-dpfp-lrsr */
  OPT_mno_epilogue_cfi = 1108,               /* -mno-epilogue-cfi */
  OPT_mno_millicode = 1109,                  /* -mno-millicode */
  OPT_mnorm = 1110,                          /* -mnorm */
  OPT_mq_class = 1111,                       /* -mq-class */
  OPT_mrtsc = 1112,                          /* -mrtsc */
  OPT_msdata = 1113,                         /* -msdata */
  OPT_msimd = 1114,                          /* -msimd */
  OPT_msize_level_ = 1115,                   /* -msize-level= */
  OPT_msoft_float = 1116,                    /* -msoft-float */
  OPT_mspfp = 1117,                          /* -mspfp */
  OPT_mspfp_compact = 1118,                  /* -mspfp-compact */
  OPT_mspfp_fast = 1119,                     /* -mspfp-fast */
  OPT_mswap = 1120,                          /* -mswap */
  OPT_mswape = 1121,                         /* -mswape */
  OPT_mtelephony = 1122,                     /* -mtelephony */
  OPT_mtls = 1123,                           /* -mtls */
  OPT_mtls9 = 1124,                          /* -mtls9 */
  OPT_mtp_regno_ = 1125,                     /* -mtp-regno= */
  OPT_mtp_regno_none = 1126,                 /* -mtp-regno=none */
  OPT_mtune_ = 1127,                         /* -mtune= */
  OPT_mucb_mcount = 1128,                    /* -mucb-mcount */
  OPT_multcost_ = 1129,                      /* -multcost= */
  OPT_mvolatile_cache = 1130,                /* -mvolatile-cache */
  OPT_mxy = 1131,                            /* -mxy */
  OPT_n = 1132,                              /* -n */
  OPT_no_canonical_prefixes = 1133,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1134,              /* -no-integrated-cpp */
  OPT_nocpp = 1135,                          /* -nocpp */
  OPT_nodefaultlibs = 1136,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1137,                   /* -nostartfiles */
  OPT_nostdinc = 1138,                       /* -nostdinc */
  OPT_nostdinc__ = 1139,                     /* -nostdinc++ */
  OPT_nostdlib = 1140,                       /* -nostdlib */
  OPT_o = 1141,                              /* -o */
  OPT_p = 1142,                              /* -p */
  OPT_pass_exit_codes = 1143,                /* -pass-exit-codes */
  /* OPT_pedantic = 1144, */                 /* -pedantic */
  OPT_pedantic_errors = 1145,                /* -pedantic-errors */
  OPT_pg = 1146,                             /* -pg */
  OPT_pie = 1147,                            /* -pie */
  OPT_pipe = 1148,                           /* -pipe */
  OPT_print_file_name_ = 1149,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1150,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1151,          /* -print-multi-directory */
  OPT_print_multi_lib = 1152,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1153,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1154,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1155,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1156,               /* -print-prog-name= */
  OPT_print_search_dirs = 1157,              /* -print-search-dirs */
  OPT_print_sysroot = 1158,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1159,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1160,                          /* -quiet */
  OPT_r = 1161,                              /* -r */
  OPT_remap = 1162,                          /* -remap */
  OPT_s = 1163,                              /* -s */
  OPT_s_bc_abi = 1164,                       /* -s-bc-abi */
  OPT_save_temps = 1165,                     /* -save-temps */
  OPT_save_temps_ = 1166,                    /* -save-temps= */
  OPT_shared = 1167,                         /* -shared */
  OPT_shared_libgcc = 1168,                  /* -shared-libgcc */
  /* OPT_specs = 1169, */                    /* -specs */
  OPT_specs_ = 1170,                         /* -specs= */
  OPT_static = 1171,                         /* -static */
  OPT_static_libasan = 1172,                 /* -static-libasan */
  OPT_static_libgcc = 1173,                  /* -static-libgcc */
  OPT_static_libgcj = 1174,                  /* -static-libgcj */
  OPT_static_libgfortran = 1175,             /* -static-libgfortran */
  OPT_static_libgo = 1176,                   /* -static-libgo */
  OPT_static_libstdc__ = 1177,               /* -static-libstdc++ */
  OPT_static_libtsan = 1178,                 /* -static-libtsan */
  /* OPT_std_c__03 = 1179, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1180, */                /* -std=c++0x */
  OPT_std_c__11 = 1181,                      /* -std=c++11 */
  OPT_std_c__1y = 1182,                      /* -std=c++1y */
  OPT_std_c__98 = 1183,                      /* -std=c++98 */
  OPT_std_c11 = 1184,                        /* -std=c11 */
  /* OPT_std_c1x = 1185, */                  /* -std=c1x */
  /* OPT_std_c89 = 1186, */                  /* -std=c89 */
  OPT_std_c90 = 1187,                        /* -std=c90 */
  OPT_std_c99 = 1188,                        /* -std=c99 */
  /* OPT_std_c9x = 1189, */                  /* -std=c9x */
  OPT_std_f2003 = 1190,                      /* -std=f2003 */
  OPT_std_f2008 = 1191,                      /* -std=f2008 */
  OPT_std_f2008ts = 1192,                    /* -std=f2008ts */
  OPT_std_f95 = 1193,                        /* -std=f95 */
  OPT_std_gnu = 1194,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1195, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1196, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1197,                    /* -std=gnu++11 */
  OPT_std_gnu__1y = 1198,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1199,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1200,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1201, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1202, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1203,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1204,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1205, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1206, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1207,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1208, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1209, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1210, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1211,                     /* -std=legacy */
  OPT_symbolic = 1212,                       /* -symbolic */
  OPT_t = 1213,                              /* -t */
  OPT_time = 1214,                           /* -time */
  OPT_time_ = 1215,                          /* -time= */
  OPT_traditional = 1216,                    /* -traditional */
  OPT_traditional_cpp = 1217,                /* -traditional-cpp */
  OPT_trigraphs = 1218,                      /* -trigraphs */
  OPT_u = 1219,                              /* -u */
  OPT_undef = 1220,                          /* -undef */
  OPT_v = 1221,                              /* -v */
  OPT_version = 1222,                        /* -version */
  OPT_w = 1223,                              /* -w */
  OPT_wrapper = 1224,                        /* -wrapper */
  OPT_x = 1225,                              /* -x */
  OPT_z = 1226,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
