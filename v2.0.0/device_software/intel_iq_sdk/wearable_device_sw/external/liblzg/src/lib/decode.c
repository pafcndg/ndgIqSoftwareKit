...
__attribute__((weak)) void LZG_write_byte(unsigned char *address,
        unsigned char value) {
	*address = value;
}
...
__attribute__((weak)) unsigned int LZG_Decode(const unsigned char *in, lzg_uint32_t insize,
        ...
        else
        {
            ...
            if (LIKELY(b))
            {
                ...
                switch (length)
                {
                    default:
                        for (i = 29; i < length; ++i)
                            LZG_write_byte(dst++,  *copy++);
                    case 29: LZG_write_byte(dst++, *copy++);
                    case 28: LZG_write_byte(dst++, *copy++);
                    case 27: LZG_write_byte(dst++, *copy++);
                    case 26: LZG_write_byte(dst++, *copy++);
                    case 25: LZG_write_byte(dst++, *copy++);
                    case 24: LZG_write_byte(dst++, *copy++);
                    case 23: LZG_write_byte(dst++, *copy++);
                    case 22: LZG_write_byte(dst++, *copy++);
                    case 21: LZG_write_byte(dst++, *copy++);
                    case 20: LZG_write_byte(dst++, *copy++);
                    case 19: LZG_write_byte(dst++, *copy++);
                    case 18: LZG_write_byte(dst++, *copy++);
                    case 17: LZG_write_byte(dst++, *copy++);
                    case 16: LZG_write_byte(dst++, *copy++);
                    case 15: LZG_write_byte(dst++, *copy++);
                    case 14: LZG_write_byte(dst++, *copy++);
                    case 13: LZG_write_byte(dst++, *copy++);
                    case 12: LZG_write_byte(dst++, *copy++);
                    case 11: LZG_write_byte(dst++, *copy++);
                    case 10: LZG_write_byte(dst++, *copy++);
                    case 9:  LZG_write_byte(dst++, *copy++);
                    case 8:  LZG_write_byte(dst++, *copy++);
                    case 7:  LZG_write_byte(dst++, *copy++);
                    case 6:  LZG_write_byte(dst++, *copy++);
                    case 5:  LZG_write_byte(dst++, *copy++);
                    case 4:  LZG_write_byte(dst++, *copy++);
                    case 3:  LZG_write_byte(dst++, *copy++);
                    case 2:  LZG_write_byte(dst++, *copy++);
                    case 1:  LZG_write_byte(dst++, *copy++);
                }
            }
            else
            {
