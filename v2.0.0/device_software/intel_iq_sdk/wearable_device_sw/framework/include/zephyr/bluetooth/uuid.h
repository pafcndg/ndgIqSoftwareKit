...
/** @def BT_UUID_GATT_PF
 *  @brief GATT Presentation Format descriptor
 */
#define BT_UUID_GATT_PF				0x2903
...
/** @brief Bluetooth UUID structure (18 bytes mem use) */
struct bt_uuid {
	/** UUID type */
	uint8_t  type;
	union {
...
/** @brief Bluetooth UUID 16bit structure (4 bytes mem use)*/
struct bt_uuid16 {
	/** UUID type */
	uint8_t  type;
	/** UUID 16 bits value */
