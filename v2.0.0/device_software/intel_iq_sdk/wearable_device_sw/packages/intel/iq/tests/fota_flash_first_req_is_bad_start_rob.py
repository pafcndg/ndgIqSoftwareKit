...
def bad_start_request(device, firmware_path):
	...
	if pub == None:
		...
		if decodedResp.firmware_update_state != FirmwareUpdateState.NONE:
			...
			print ("---------------------------------")
			print ("------  BAD START REQUEST  ------")
			print ("---------------------------------")
		else:
			print ("-------------------------------------------------")
			print ("------  DEVICE READY => BAD START REQUEST  ------")
			print ("-------------------------------------------------")
	...
	notif.firmware_total_length = 600000
	print "Firmware size: %d"%notif.firmware_total_length
...
if __name__ == "__main__":
	...
	bad_start_request(device, sys.argv[2])
