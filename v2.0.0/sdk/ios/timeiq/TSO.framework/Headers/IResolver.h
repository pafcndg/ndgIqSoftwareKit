...
//  source: //com/intel/wearable/platform/timeiq/api/resolver/IResolver.java
//

#ifndef _IResolver_H_
#define _IResolver_H_
...
/**
 @brief IResolver Resolves a search term to a location and a phone number to a relevant business place, considering anchor location
 */
@protocol IResolver < NSObject >
...
#define ComIntelWearablePlatformTimeiqApiResolverIResolver IResolver
